...
<h3 class="mb-4">Rekapitulasi Pendaftar Berdasarkan Wilayah Asal</h3>
...
<h4 class="mb-3">Detail Data Siswa per Wilayah</h4>
                        ...
                        <?php foreach ($list_siswa_wilayah as $siswa) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    if($siswa['kelompok'] == 'Bandung Raya') $badge_color = 'bg-info text-dark';
                                    elseif($siswa['kelompok'] == 'Luar Bandung') $badge_color = 'bg-warning text-dark';
                                    elseif($siswa['kelompok'] == 'Luar Jawa Barat') $badge_color = 'bg-danger';
                                    ?>
